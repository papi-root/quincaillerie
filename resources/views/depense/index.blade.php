  ...
  <div class="container-fluid">
    ...
    <div class="card card-default">
      <div class="card-header text-center">
        <h4 class="text-center" style="background: #1D62F0; color: #fff; padding: 10px;">DEPENSES</h4>
      </div>
    ...
    <br>
      <div class="card-body">
        <table class="table table-striped" id="datatable">
          ...
          @if($depenses->count() > 0)
            @foreach($depenses as $d)
                <tr>
                  ...
                  <td>{{ $d->montant }}</td>
                  <td>
                    <a href="#" class="show-modal-del btn btn-danger btn-sm" data-id_depense="{{$d->id}}">
          ...
          @else
            <tr>
              <td colspan="5" class="text-center"> Aucune Dépense !</td>
            </tr>
          @endif
          </tbody>
    ...
    <div id="showmodalDel" class="modal fade" role="dialog" tabindex="-1" >
     <div class="modal-dialog" >
         <div class="modal-content">
             ...
             <div class="modal-body">
               <form class="text-center" action="{{route('depense.supprimer')}}" method="post">
                 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                 <input type="hidden" name="id_depense" type="val" id="id_depense">
...
<script>
    ...
    $(document).on('click', '.show-modal-add', function() {
        $('#showmodalAdd').modal('show');
        $('.modal-title').text('Ajout Dépense');
    ...
    $(document).on('click', '.show-modal-del', function() {
      ...
      $('#id_depense').val($(this).data('id_depense'));
